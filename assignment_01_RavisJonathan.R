...
week2_sleep <- [7.1, 7.4, 7.9, 6.5, 8.1, 8.2, 8.9]
...
def mean(week1_sleep):
  total = 0
for num in week1_sleep:
  total = total + num
return total / len(week1_sleep)

print(mean([6.1, 8.8, 7.7, 6.4, 6.2, 6.9, 6.6]))
6.957
...
names(week1_sleep) <- ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]
names(week2_sleep) <- ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]
...
for num in week1_sleep:
  total = total + num
return total / len(week1_sleep)
print(mean([8.8, 7.7, 6.4, 6.2, 6.9]))
7.2
weekdays1_mean <- 7.2


def mean(week2_sleep):
  total = 0
for num in week2_sleep:
  total = total + num
return total / len(week1_sleep)
print(mean([7.4, 7.9, 6.5, 8.1, 8.2]))
7.62
weekdays2_mean <- 7.62
