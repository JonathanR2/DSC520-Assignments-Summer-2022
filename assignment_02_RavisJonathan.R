...
getwd("/home/JonathanR2/Workspaces/DSC520")

## List the contents of the working directory with the `dir()` function
dir(getwd("/home/JonathanR2/Workspaces/DSC520"))
...
## Use `setwd()` if needed
setwd("C:/Users/jonat/Desktop/DSC520")
...
voter_turnout_df1 <- ___read_excel("dataG04ResultsDetail2004-11-02.xls")
...
voter_turnout_df2 <- read_excel("data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", skip = 2, col_names = c('ward_percint', "ballots_cast", "registered_voters", "voter_turnout")
